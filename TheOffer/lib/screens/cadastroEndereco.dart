...
class TelaCadastroEndereco extends StatefulWidget {
  final int index;
  TelaCadastroEndereco(this.index);
  @override
    ...
    return ScopedModelDescendant<MainModel>(
      ...
      return Scaffold(
          ...
          appBar: AppBar(
              ...
              title: Text('Cadastro de Endereço', style: TextStyle(color: Colors.principalTheOffer)
              )
            ),
            body: body(),
          );
      ...
      builder: (BuildContext context, Widget child, MainModel model) {
          return Row(
            ...
            children: <Widget>[SingleChildScrollView(
              child: Container(
                width: MediaQuery.of(context).size.width > 550.0 ? 500.0 : MediaQuery.of(context).size.width * 0.95,
                child: Form(
      ...
      child: Column(
        children: <Widget>[
          Align(
            ...
            child: Text("Bairro", style: TextStyle(fontSize: 17, color: Colors.secundariaTheOffer)),
          ),
           Container(   
    ...
    setState(() {
      ...
      responseBody['bairros'].forEach((categoriaJson) {
          ...
          listaBairros.add(new DropdownMenuItem(
              child: new Text(categoriaJson['nome'], style: TextStyle(color: Colors.principalTheOffer),), value: int.parse(categoriaJson['id'])));
          });
        }
      );
    });
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            ...
            enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Colors.secundariaTheOffer))),
